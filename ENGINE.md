...
5. **`node tests/run-all.js` must be green before every push.** 31 suites, 1916 assertions;
...
**31 suites · 1916 assertions.** `tests/run-all.js` is the registry — a new
