...
**27 suites, 1441 assertions.** `run-all.js` is the registry — **a test file that is not listed
...
| `legal-analysis` (207) | `forensic-report.js` | Party and jurisdiction derivation, legal subjects, **PD16 language** (no scores, no bands, no hedging), the §15.2 narrative gate, sentence splitting, page anchors, and SEALED FINDINGS integrity. |
