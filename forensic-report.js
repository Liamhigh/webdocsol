...
function secFindingDetails(ctx, data) {
  ...
  ctx.para('One entry per substantive indicator, ranked by severity: the party it names, its page, what it means in plain words, the verbatim quoted record, and the candidate law for counsel. Structural notes and multi-stage pattern signals are covered in their own sections. Every entry is an investigative indicator, not a determination of guilt.', { size: 9, font: ctx.f.timesItalic, color: GRAY, after: 10 });
