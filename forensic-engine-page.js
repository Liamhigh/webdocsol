...
var VO_NAME_TOK = "(?:[A-Z][A-Za-z'\u2019.-]*|de|van|der|den|du|le|la|von|bin|al)";
var VO_TITLE_NAME_RE = new RegExp("\\b(?:Mr|Mrs|Ms|Miss|Dr|Prof|Adv|Advocate|Judge|Justice)\\.?[ \\t]+([A-Z][A-Za-z'\u2019.-]*(?:[ \\t]+" + VO_NAME_TOK + "){1,3})", "g");
var VO_NAME_SEQ_RE = new RegExp("^([A-Z][A-Za-z'\u2019.-]*(?:[ \\t]+" + VO_NAME_TOK + "){1,3})");
